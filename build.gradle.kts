...
val projectName = "modb-anime-planet"
...
dependencies {
    api(kotlin("stdlib"))
    api("io.github.manamiproject:modb-core:10.0.0")

    implementation(platform(kotlin("bom")))

    testImplementation("ch.qos.logback:logback-classic:1.4.14")
    testImplementation("io.github.manamiproject:modb-test:1.5.4")
}
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("This lib contains downloader and converter for downloading raw data from anime-planet.com and convert it to an anime object.")
