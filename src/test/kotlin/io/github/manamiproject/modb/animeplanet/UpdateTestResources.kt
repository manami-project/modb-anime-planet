...
fun main() {
    ...
    downloader.download("pripara-movie-minna-no-akogare-lets-go-prix-paris").writeToFile(resourceFile("file_converter_tests/episodes/1.html"))
    downloader.download("code-geass-lelouch-of-the-rebellion-r2").writeToFile(resourceFile("file_converter_tests/episodes/25.html"))
    downloader.download("detective-conan").writeToFile(resourceFile("file_converter_tests/episodes/1010+.html"))
    ...
    downloader.download("40meterp-heartbreak-monochrome").writeToFile(resourceFile("file_converter_tests/picture_and_thumbnail/other_screenshots_available.html"))
    ...
    downloader.download("uzaki-chan-wants-to-hang-out-2").writeToFile(resourceFile("file_converter_tests/status/tba.html"))
    downloader.download("laid-back-camp-2nd-season").writeToFile(resourceFile("file_converter_tests/status/year_-_same_year.html"))
    downloader.download("attack-on-titan-the-final-season-part-ii").writeToFile(resourceFile("file_converter_tests/status/year_-_year_in_the_future.html"))
    downloader.download("banner-of-the-stars").writeToFile(resourceFile("file_converter_tests/status/year_-_year_in_the_past.html"))
